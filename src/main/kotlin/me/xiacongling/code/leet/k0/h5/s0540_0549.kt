...
import me.xiacongling.code.util.UnionFind

@Solution(
    id = 574, title = "省份数量", difficulty = Difficulty.MEDIUM, description = """
...
fun main() {
    println(findCircleNum(arrayOf(intArrayOf(1, 1, 0), intArrayOf(1, 1, 0), intArrayOf(0, 0, 1))))
